...
- (void)viewDidLoad {
    ...
    self.textView.text = @"My name is Zihua";
...
- (IBAction)pressMe:(id)sender {
    ...
    [self resignFirstResponder]; // Notifies this object that it has been asked to relinquish its status as first responder in its window.
